...
urlpatterns = patterns('',
    ...
    url(r'^unitofferings/(?P<course_code>[a-zA-Z0-9-_]+)/update/$', views.update_offering, name='update_offering'),
    url(r'^unitofferings/(?P<course_code>[a-zA-Z0-9-_]+)/members/$', views.offering_members, name='offering_members'),
    url(r'^unitofferings/(?P<course_code>[a-zA-Z0-9-_]+)/register/existing/$', views.register_existing, name='register_existing'),
    url(r'^unitofferings/(?P<course_code>[a-zA-Z0-9-_]+)/register/$', views.register, name='register'),
)
