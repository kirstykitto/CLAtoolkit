...
class UserProfileForm(forms.ModelForm):
    ...
    def clean(self):
        if not ((self.cleaned_data.get('fb_id')) 
            ...
            elif len(fr_registered)>0 and self.cleaned_data.get('course.code') == 'IFN614':
    ...
    class Meta:
        model = UserProfile
        fields = ('fb_id', 'twitter_id', 'forum_id', 'google_account_name', 'diigo_username', 'blog_id', 'github_account_name')
